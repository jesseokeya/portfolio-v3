...
![Benny Agent on the web, fetching call logs, generating images, and handling requests through conversation](/agent-image-2.png)
...
<div style="display: flex; gap: 16px; justify-content: center; margin: 24px 0;">
  <img src="/agent-mobile-2.png" alt="The AskBenny mobile app interface" style="width: 48%; border-radius: 8px;" />
  <img src="/agent-mobile.png" alt="The AskBenny mobile agent sending appointment reminders via SMS" style="width: 48%; border-radius: 8px;" />
</div>

<div style="display: flex; gap: 16px; justify-content: center; margin: 24px 0;">
  <img src="/agent-mobile-3.png" alt="The AskBenny mobile app" style="width: 48%; border-radius: 8px;" />
  <img src="/agent-mobile-4.png" alt="The AskBenny mobile app" style="width: 48%; border-radius: 8px;" />
</div>
